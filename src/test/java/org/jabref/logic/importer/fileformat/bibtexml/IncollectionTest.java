...
public class IncollectionTest {
    ...
    Incollection teste1 = new Incollection();
    ...
    public void validate32() {
        ...
        Nome32 = teste1.getBooktitle();
        assertEquals(Nome32, "booktitle");
    }
    ...
    public void validate33() {
        String Nome33;
        teste1.setType("type");
        Nome33 = teste1.getType();
        assertEquals(Nome33, "type");
    }

    @Test
    public void validate34() {
        BigInteger Nome34;
        teste1.setChapter(null);
        Nome34 = teste1.getChapter();
        assertEquals(Nome34, null);
    }

    @Test
    public void validate35() {
        String Nome35;
        teste1.setPages("pages");
        Nome35 = teste1.getPages();
        assertEquals(Nome35, "pages");
    }
